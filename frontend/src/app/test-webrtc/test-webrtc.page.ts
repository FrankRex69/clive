...
@Component({
  ...
  templateUrl: './test-webrtc.page.html',
  styleUrls: ['./test-webrtc.page.scss'],
})

export class TestWebrtcPage implements AfterViewInit {
  ...
  private addIncominMessageHandler(): void {
    console.log('addIncominMessageHandler()');
